...
/** START RF Reg. Table for INC 39F0 */
static INC_UINT8 g_acT39F0KorI2CValue_19200[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
...
static INC_UINT8 g_acT39F0KorI2CValue_24576[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
	...
	{	//24576KHz 9BK.dat (189.008Mhz)
		0x55, 0x9F, 0xF1, 0xF8, 0x02, 0x41, 0xFC, 0x00, 0x00, 0xC0, 0x00, 0x0C, 0xC3, 0x00, 0xC0, 0x40, 
		0x73, 0x80, 0x03, 0xE8, 0x1C, 0xC0, 0x88, 0x33, 0x08, 0xF0, 0xF0, 0xD0, 0x04, 0x00, 0x1E, 0x47, 
		0x4D, 0x1E, 0x2B, 0x03, 0xE8, 0xC1, 0x88, 0xE8, 0xE0, 0x10, 0x40, 0xEC, 0x00, 0x00, 0x00, 0x00, 
	...
	{	//24576KHz 12AK.dat (205.280Mhz)
		0x55, 0x9F, 0xF1, 0xF8, 0x02, 0x41, 0xFC, 0x00, 0x00, 0xC0, 0x00, 0x0C, 0xC3, 0x00, 0xC0, 0x40, 
		0x73, 0x80, 0x03, 0xE8, 0x1C, 0xC0, 0x88, 0x33, 0x08, 0xF0, 0xF0, 0xD0, 0x04, 0x00, 0x21, 0x42, 
		0x4D, 0x0A, 0x2B, 0x03, 0xE8, 0xC1, 0x88, 0xE8, 0xE0, 0x10, 0x40, 0xEC, 0x00, 0x00, 0x00, 0x00, 
		0x0F, 0x01, 0x00, 0x70, 0x4C, 0xF0, 0x8C, 0xF0, 0x80, 0xA0, 0xC0, 0x22, 0x20, 0x80, 0x10, 0x00, 
		0x88, 0x80, 0x44, 0x44, 0x58, 0x34, 0x72, 0x68, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x0B, 0x2B, 
		0x00, 0x80, 0x60, 0x00, 0x00, 0x00, 0x94, 0x44, 0x00, 0x12, 0x0B, 0x18, 0x18, 0x0E, 0x04, 0x00, 
		0x00, 0x00, 0xFB, 0xB0, 0x68, 0x20, 0x00, 0x08, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
static INC_UINT8 g_acT39F0KorI2CValue_27000[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
...
static INC_UINT8 g_acT39F0KorI2CValue_27120[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
...
/** END RF Reg. Table for INC T39F0 */


/** START RF Reg. Table for INC T39F1 */
static INC_UINT8 g_acT39F1KorI2CValue_19200[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
	{	//19200KHz 7AK.dat (175.280Mhz)
		0x55, 0x9F, 0xF1, 0xF8, 0x02, 0x41, 0xFC, 0x00, 0x00, 0xC0, 0x00, 0x0C, 0xC3, 0x00, 0xC0, 0x40, 
		0x5A, 0x80, 0x03, 0xE8, 0x0C, 0xC0, 0x88, 0x33, 0x08, 0xF0, 0xF0, 0xD0, 0x02, 0x00, 0x12, 0x41, 
...
static INC_UINT8 g_acT39F1KorI2CValue_24576[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
	{	//24576KHz 7AK.dat (175.280Mhz)
		0x55, 0x9F, 0xF1, 0xF8, 0x02, 0x41, 0xFC, 0x00, 0x00, 0xC0, 0x00, 0x0C, 0xC3, 0x00, 0xC0, 0x40, 
...
static INC_UINT8 g_acT39F1KorI2CValue_27000[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
	{	//27000KHz 7AK.dat (175.280Mhz)
		0x55, 0x9F, 0xF1, 0xF8, 0x02, 0x41, 0xFC, 0x00, 0x00, 0xC0, 0x00, 0x0C, 0xC3, 0x00, 0xC0, 0x40, 
		0x7F, 0x80, 0x03, 0xE8, 0x0C, 0xC0, 0x88, 0x33, 0x08, 0xF0, 0xF0, 0xD0, 0x03, 0x00, 0x13, 0x43, 
...
static INC_UINT8 g_acT39F1KorI2CValue_27120[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
	{ //27120KHz 7AK.dat (175.280Mhz)
		0x55, 0x9F, 0xF1, 0xF8, 0x02, 0x41, 0xFC, 0x00, 0x00, 0xC0, 0x00, 0x0C, 0xC3, 0x00, 0xC0, 0x40, 
		0x7F, 0x80, 0x03, 0xE8, 0x0C, 0xC0, 0x88, 0x33, 0x08, 0xF0, 0xF0, 0xD0, 0x03, 0x00, 0x13, 0x43, 
...
/** END RF Reg. Table for INC T39F1 */
...
static INC_UINT8 INC_RF500_START_T39F0(INC_UINT8 ucI2CID, INC_UINT32 ulRFChannel, ENSEMBLE_BAND ucBand)
{
	INC_UINT16 uiPos;
	...
	if(ucBand == KOREA_BAND_ENABLE){
		...
		switch(m_ucPLL_Mode){
		case INPUT_CLOCK_19200KHZ : pDataBuff = g_acT39F0KorI2CValue_19200[uiPos]; break;
		case INPUT_CLOCK_24576KHZ : pDataBuff = g_acT39F0KorI2CValue_24576[uiPos]; break;
		case INPUT_CLOCK_27000KHZ : pDataBuff = g_acT39F0KorI2CValue_27000[uiPos]; break;
		case INPUT_CLOCK_27120KHZ : pDataBuff = g_acT39F0KorI2CValue_27120[uiPos]; break;
		default : pDataBuff = g_acT39F0KorI2CValue_24576[uiPos]; break;
		}
	}
...
static INC_UINT8 INC_RF500_START_T39F1(INC_UINT8 ucI2CID, INC_UINT32 ulRFChannel, ENSEMBLE_BAND ucBand)
{
	INC_UINT16 uiPos;
	INC_UINT8* pDataBuff = INC_NULL;
	...
	if(ucBand == KOREA_BAND_ENABLE){
		...
		switch(m_ucPLL_Mode){
		case INPUT_CLOCK_19200KHZ : pDataBuff = g_acT39F1KorI2CValue_19200[uiPos]; break;
		case INPUT_CLOCK_24576KHZ : pDataBuff = g_acT39F1KorI2CValue_24576[uiPos]; break;
		case INPUT_CLOCK_27000KHZ : pDataBuff = g_acT39F1KorI2CValue_27000[uiPos]; break;
		case INPUT_CLOCK_27120KHZ : pDataBuff = g_acT39F1KorI2CValue_27120[uiPos]; break;
		default : pDataBuff = g_acT39F1KorI2CValue_24576[uiPos]; break;
		}
	}
	else if(ucBand == EXTERNAL_ENABLE) 
		return INC_SUCCESS;
...
{
	INC_UINT8 result = INC_ERROR;	

	if(ucChip == 0)
	{
		result = INC_RF500_START_T39F0(ucI2CID, ulRFChannel, ucBand);
	}
	else if(ucChip == 1)
	{
		result = INC_RF500_START_T39F1(ucI2CID, ulRFChannel, ucBand);
	}
